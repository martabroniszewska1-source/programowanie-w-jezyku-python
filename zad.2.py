...
class Employee:
    ...
    def __str__(self):
        return (f"Employee: {self.first_name} {self.last_name} (Data zatrudnienia: {self.hire_date}, "
                f"Miasto: {self.city})")
...
# TWÓRZENIE INSTANCJI
library_wroclaw = Library("Wrocław", "ul. Czytelnicza 10", "50-001", "8:00-18:00", "71 111 22 33")
library_krakow = Library("Kraków", "ul. Książkowa 5", "30-001", "9:00-17:00", "12 999 88 77")
...
employee1 = Employee("Marta", "Zielińska", date(2020, 10, 1), date(1990, 5, 15), "Wrocław", "Słoneczna 1", "50-100",
                     "71 555 66 77")
employee2 = Employee("Tomasz", "Wójcik", date(2019, 3, 15), date(1985, 11, 22), "Kraków", "Gwiezdna 2", "30-200",
                     "12 111 22 33")
employee3 = Employee("Kasia", "Dąbrowska", date(2022, 7, 1), date(1995, 8, 8), "Wrocław", "Leśna 3", "50-300",
                     "71 444 55 66")
